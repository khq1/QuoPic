...
.then( data =>{ 
document.getElementById("text_box").innerHTML = `${data.content} <br><br><i>${data.author}`
...
const string3 = "?random=";
  linktorandomIMGapi = string1 + imagewidth + string2 + imageheight + string3 + random;
  document.getElementById("tlo").style.background =
